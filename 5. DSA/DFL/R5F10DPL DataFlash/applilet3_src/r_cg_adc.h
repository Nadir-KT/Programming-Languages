...
#define _80_AD_CLOCK_SUPPLY                       (0x80U) /* supply input clock */
...
*/
/* Specification of analog input channel (ADISS, ADS3 - ADS0) */
/* Select mode */
...
#define _00_AD_TRIGGER_INTTM02                    (0x00U) /* INTTM02 */
#define _01_AD_TRIGGER_INTTM04                    (0x01U) /* INTTM04 */
#define _02_AD_TRIGGER_ADTRG_WITHOUT_NOISE_FILTER (0x02U) /* ADTRG (WITHOUT NOISE FILTER) */
#define _03_AD_TRIGGER_ADTRG_WITH_NOISE_FILTER    (0x03U) /* ADTRG (WITH NOISE FILTER) */
...
#define _00_AD_ADPC_9ANALOG                       (0x00U) /* ANI0 - ANI8 */
#define _09_AD_ADPC_8ANALOG                       (0x09U) /* ANI0 - ANI7 */
