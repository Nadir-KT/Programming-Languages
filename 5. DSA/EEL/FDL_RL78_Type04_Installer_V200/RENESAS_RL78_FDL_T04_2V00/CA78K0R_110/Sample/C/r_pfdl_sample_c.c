...
/* Version     = V3.01(Target FDL Version for CA78K0R is V1.05)                 */
/* Target CPU  = RL78/G13 ( R5F100LEA / QB-R5F100LE-TB )                        */
/* Tool-Chain  = CS+ for CA[CA78K0R],CX (V3.00)                                 */
/*                                                                              */
/* Date        = 11.14.2018                                                     */
/*                                                                              */
/*==============================================================================*/
...
/*               : 06.08.2011 1.00 First Release                                */
/*               : 06.14.2011 1.01 Adjustments comment.                         */
/*               : 07.01.2011 2.00 Bug fixing.                                  */
/*               : 10.26.2012 3.00 Change file name. Adjustments comment.       */
/*                                 Correct the grammatical(Macro name) errors.  */
/*               : 11.14.2018 3.01 Change comment. Source code improvement.     */
/********************************************************************************/

/******************************************************************************
 Expanded function
******************************************************************************/
#pragma sfr                             /* SFR(特定レジスタ群)領域利用宣言   */
#pragma DI                              /* 割り込み禁止命令利用宣言          */
#pragma EI                              /* 割り込み許可命令利用宣言          */
...
/******************************************************************************
 interrupt function
******************************************************************************/
#pragma interrupt INTWDTI r_pfdl_samIntWdt RB3  /* WDT割り込み(RB3使用)      */
...
#define R_PFDL_SAM_LED1_INIT() P6.2 = 1, PM6.2 = 0
                                        /* オンボードのLED1を初期化(非点灯) */
#define R_PFDL_SAM_LED1_ON()   P6.2 = 0 /* オンボードのLED1を点灯           */
#define R_PFDL_SAM_LED1_OFF()  P6.2 = 1 /* オンボードのLED1を消灯           */

#define R_PFDL_SAM_LED2_INIT() P6.3 = 1, PM6.3 = 0
                                        /* オンボードのLED2を初期化(非点灯) */
#define R_PFDL_SAM_LED2_ON()   P6.3 = 0 /* オンボードのLED2を点灯           */
#define R_PFDL_SAM_LED2_OFF()  P6.3 = 1 /* オンボードのLED2を消灯           */
...
******************************************************************************/
__interrupt void r_pfdl_samIntWdt( void )
{
