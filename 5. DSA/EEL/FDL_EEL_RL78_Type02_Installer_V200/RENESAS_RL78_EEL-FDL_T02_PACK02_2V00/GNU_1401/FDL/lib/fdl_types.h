...
* Mod. Date     : $Date: 2014/06/11 16:12:13MESZ $
* Device(s)     : RL78
...
} __attribute__ ((__packed__)) fdl_command_t;             /* ---------------------------------------------- */
...
} __attribute__ ((__packed__)) fdl_status_t;              /* ---------------------------------------------- */
...
{                                                         /* ---------------------------------------------- */
            ...
            fdl_u08*        data_pu08;                    /* 2, W, pointer to the 1'st byte of data buffer  */
