...
__far const eel_u08 eel_descriptor[EEL_VAR_NO+2] __attribute__ ((section ("EEL_CNST"), aligned(2)))=
{
...
/*******                                                                                           *******/
/*********************************************************************************************************/
__far const eel_u08   eel_internal_cfg_cau08[] __attribute__ ((section ("EEL_CNST"), aligned(2)))    = {0x40};
/*********************************************************************************************************/
/*******                                                                                           *******/
