...
* Mod. Date     : $Date: 2014/06/11 16:11:04MESZ $
* Device(s)     : RL78
...
} __attribute__ ((__packed__)) eel_command_t;             /* ---------------------------------------------------- */
...
} __attribute__ ((__packed__)) eel_driver_status_t;       /* ---------------------------------------------------- */
...
} __attribute__ ((__packed__)) eel_status_t;              /* ---------------------------------------------------- */


/* EEL request type */
typedef struct
{                                                         /* ---------------------------------------------------- */
            eel_u08*       address_pu08;                  /* 2, r/w, source/destination RAM-address               */
