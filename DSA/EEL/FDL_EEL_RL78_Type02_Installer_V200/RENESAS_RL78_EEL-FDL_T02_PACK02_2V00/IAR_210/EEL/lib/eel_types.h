...
/* EEL request type */
typedef struct {                                            /* ---------------------------------------------------- */
                        eel_u08 __near *  address_pu08;     /* 2, r/w, source/destination RAM-address               */
...
#define R_EELT02_STATIC_ASSERT_SIZE(a, b) (1/(sizeof(a) == (unsigned int)(b)))
#define R_EELT02_STATIC_ASSERT_RANGE(a, b, c) ((1/(sizeof(a) >= (unsigned int)(b))) * (1/(sizeof(a) <= (unsigned int)(c))))

enum
{
            R_EELT02_ASSERT_CHECK
            = R_EELT02_STATIC_ASSERT_SIZE(eel_u08, 1)             /* Check unsigned type */
            + R_EELT02_STATIC_ASSERT_SIZE(eel_u16, 2)             /* Check unsigned type */
            + R_EELT02_STATIC_ASSERT_SIZE(eel_u32, 4)             /* Check unsigned type */
            + R_EELT02_STATIC_ASSERT_SIZE(eel_command_t, 1)       /* Check enumeration type */
            + R_EELT02_STATIC_ASSERT_SIZE(eel_driver_status_t, 1) /* Check enumeration type */
            + R_EELT02_STATIC_ASSERT_SIZE(eel_status_t, 1)        /* Check enumeration type */
            + R_EELT02_STATIC_ASSERT_RANGE(eel_request_t, 5, 6)   /* Check packed/unpacked structure type */
};
