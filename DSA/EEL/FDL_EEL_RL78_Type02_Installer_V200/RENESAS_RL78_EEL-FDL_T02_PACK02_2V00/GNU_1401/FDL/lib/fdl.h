...
* Lib. Version  : $RL78_FDL_LIB_VERSION_T02_GNU: V1.01 $
* Mod. Revision : $Revision: 1.5 $
* Mod. Date     : $Date: 2014/06/11 16:12:11MESZ $
* Device(s)     : RL78
...
/* ---------------------------------------------------------------------------------------------------------------*/
extern  fdl_status_t  FDL_Init(const fdl_descriptor_t __far* descriptor_pstr)  __attribute__ ((section ("FDL_CODE")));
...
/*  Return:       -                                                                                               */
/* ---------------------------------------------------------------------------------------------------------------*/
extern  void  FDL_Open(void)  __attribute__ ((section ("FDL_CODE")));
...
/*  Return:       -                                                                                               */
/* ---------------------------------------------------------------------------------------------------------------*/
extern  void  FDL_Close(void)  __attribute__ ((section ("FDL_CODE")));
...
/*  Return:       -                                                                                               */
/* ---------------------------------------------------------------------------------------------------------------*/
extern  void  FDL_Execute(fdl_request_t* request_pstr)  __attribute__ ((section ("FDL_CODE")));
...
/*  Return:       -                                                                                               */
/* ---------------------------------------------------------------------------------------------------------------*/
extern  void  FDL_Handler(void)  __attribute__ ((section ("FDL_CODE")));
...
/* ---------------------------------------------------------------------------------------------------------------*/
extern  fdl_status_t  FDL_Abort(void)  __attribute__ ((section ("FDL_CODE")));
...
/* ---------------------------------------------------------------------------------------------------------------*/
extern  fdl_status_t  FDL_StandBy(void)  __attribute__ ((section ("FDL_CODE")));
...
/* ---------------------------------------------------------------------------------------------------------------*/
extern  fdl_status_t  FDL_WakeUp(void)  __attribute__ ((section ("FDL_CODE")));
...
/* ---------------------------------------------------------------------------------------------------------------*/
extern  fdl_u08 __far* FDL_GetVersionString(void)  __attribute__ ((section ("FDL_CODE")));
