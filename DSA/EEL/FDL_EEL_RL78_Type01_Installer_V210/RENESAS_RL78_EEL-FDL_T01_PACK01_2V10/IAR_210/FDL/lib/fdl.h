...
/* ---------------------------------------------------------------------------------------------------------------*/
extern __far_func fal_status_t FAL_Init(const fal_descriptor_t __far * descriptor_pstr);
...
/*  Return:       -                                                                                               */
/* ---------------------------------------------------------------------------------------------------------------*/
extern __far_func void FAL_Execute(fal_request_t __near * request_pstr);
